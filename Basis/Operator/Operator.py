...
class Operator(object):
    ...
    @classmethod
    def operator_sigmax(cls,N,target_index):
        ##  类型检查模块
        assert isinstance(N, int), "N必须是int类型"
        ...
        return Operator('sigmax',N,target_index,data,2)

    ##  构造Pauli-Y算符的静态函数--------------------------------------------------------------------------------------------------------

    @classmethod
    def operator_sigmay(cls,N,target_index):
        ##  类型检查模块
        assert isinstance(N, int), "N必须是int类型"
        assert isinstance(target_index, int), "target_index必须是int类型"
        ...
        return Operator('sigmay',N,target_index,data,2)

    ##  构造Pauli-Z算符的静态函数--------------------------------------------------------------------------------------------------------

    @classmethod
    def operator_sigmaz(cls, N, target_index):
        ##  类型检查模块
        assert isinstance(N, int), "N必须是int类型"
        assert isinstance(target_index, int), "target_index必须是int类型"
        ...
        return Operator('sigmaz', N, target_index, data,2)

    ##  构造Pauli-下降算符的静态函数-----------------------------------------------------------------------------------------------------

    @classmethod
    def operator_sigmaminus(cls, N, target_index):
        ##  类型检查模块
        assert isinstance(N, int), "N必须是int类型"
        assert isinstance(target_index, int), "target_index必须是int类型"
        ...
        return Operator('sigmaminus', N, target_index, data,2)

    ##  构造Pauli-上升算符的静态函数-----------------------------------------------------------------------------------------------------

    @classmethod
    def operator_sigmaplus(cls, N, target_index):
        ##  类型检查模块
        assert isinstance(N, int), "N必须是int类型"
        assert isinstance(target_index, int), "target_index必须是int类型"
        ...
        ##  赋值模块
        data = np.array([[0,1],[1,0]])+1j*np.array([[0,-1j],[1j,0]])
        return Operator('sigmaplus', N, target_index, data,2)

    ##  构造单位算符的静态函数------------------------------------------------------------------------------------------------------------

    @classmethod
    def operator_identity(cls, N, target_index,dim):
        ##  类型检查模块
        assert isinstance(N, int), "N必须是int类型"
        assert isinstance(target_index, int), "target_index必须是int类型"
        ...
        return Operator('identity', N, target_index, data,dim)
